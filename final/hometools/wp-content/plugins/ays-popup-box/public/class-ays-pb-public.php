...
class Ays_Pb_Public {
	...
	public function ays_generate_popup( $attr ){
        ...
        if(isset($popupbox['onoffswitch']) && $popupbox['onoffswitch'] == 'On'){
            ...
            //Close button text
            $ays_pb_close_button_val = (isset($options['close_button_text']) && $options['close_button_text'] != '') ? $options['close_button_text'] : '✕';
                ...
                $popupbox_view .= "
                    ...
                    (function( $ ) {
                        ...
                        $(document).ready(function(){
                            ...
                            let ays_pb_delayOpen_".$id.";
                            if (isMobile && " . $enable_open_delay_mobile . ") {
                                ays_pb_delayOpen_".$id." = parseInt($(document).find('.ays_pb_delay_mobile_".$id."').val());
                                var checkInp = $('#ays-pb-modal-checkbox_".$id."');

                                if ( ays_pb_delayOpen_".$id." == 0 && " . $ays_pb_scroll_top . " == 0 ) {
            ...
            if ($close_button_delay != 0 && $closeButton != 'on' && $ays_pb_scroll_top == 0) {
                ...
                <script>
                    jQuery(document).ready(function() {
                        ...
                        if (window.innerWidth < 768 && " . $enable_open_delay_mobile . ") {
                            if (".$ays_pb_open_delay_mobile.") {
                                closeBtnDelay += Math.floor(".$ays_pb_open_delay_mobile.");
                            }
                        } else {
                            if (".$ays_pb_delay." != 0) {
                                closeBtnDelay += Math.floor(".$ays_pb_delay.");
                            }
                        }
